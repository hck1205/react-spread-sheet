...
export const SHEET_CLASSNAME = {
  ...
  HEADER_COL: 'relative shrink-0 border-r text-center text-xs',
  HEADER_RESIZE_HANDLE: 'absolute right-0 top-0 h-full w-2 cursor-col-resize',
  SCROLL_CONTAINER: 'overflow-auto',
  GRID_FOCUS: 'outline-none',
  ROW_HEADER: 'relative select-none border-b border-r text-center text-xs',
  ROW_RESIZE_HANDLE: 'absolute bottom-0 left-0 h-2 w-full cursor-row-resize',
